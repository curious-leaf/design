...
export const buttonVariants = cva({
  ...
  compoundVariants: [
    ...
    { theme: "primary", variant: "outline", class: "hover:bg-primary-lighter" },
    ...
    { theme: "secondary", variant: "outline", class: "hover:bg-gray-100" },
    ...
    { theme: "positive", variant: "outline", class: "hover:bg-green-lighter" },
    ...
    { theme: "negative", variant: "outline", class: "hover:bg-red-lighter" },
